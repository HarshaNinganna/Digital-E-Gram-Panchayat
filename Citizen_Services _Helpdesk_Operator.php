...
<div class="container">
    <h1 class="mt-4">Welcome Citizen Services Helpdesk Operator</h1>
    <p class="lead">Provide helpdesk support and assist citizens with their queries.</p>
    <!-- Add more content for Citizen Services Helpdesk Operator role as per requirements -->
</div>
