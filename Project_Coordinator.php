...
<div class="container">
    <h1 class="mt-4">Welcome Project Coordinator</h1>
    <p class="lead">Oversee and coordinate projects to ensure timely and efficient execution.</p>
    <!-- Add more content for Project Coordinator role as per requirements -->
</div>
