...
<div class="container">
    <h1 class="mt-4">Welcome Data Entry Operator</h1>
    <p class="lead">Enter and manage community-related data efficiently.</p>
    <!-- Add more content for Data Entry Operator role as per requirements -->
</div>
